...
Please note: `SPAC::Auto` has some internal bugs and is not supported in this version - user can temporarily use our python simulator to do dse first.  
...
- `SPAC::Auto`, `SPAC::PerfModel` bugfix.
