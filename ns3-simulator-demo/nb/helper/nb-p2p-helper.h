 ...
 */
#ifndef NB_P2P_HELPER_H
#define NB_P2P_HELPER_H
...
/**
 * @brief Build a set of NbP2PNetDevice objects
 *
 * Normally we eschew multiple inheritance, however, the classes
 * PcapUserHelperForDevice and AsciiTraceUserHelperForDevice are
 * "mixins".
 */
class NbP2PHelper : public PcapHelperForDevice, public AsciiTraceHelperForDevice
{
  public:
    /**
     * Create a NbP2PHelper to make life easier when creating point to
     * point networks.
     */
    NbP2PHelper();

    ~NbP2PHelper() override
    {
    }
     ...
     * NbP2PNetDevice created through NbP2PHelper::Install.
     */
     ...
     *
     * Set these attributes on each ns3::NbP2PNetDevice created
     * by NbP2PHelper::Install
     */
     ...
     * @param value the value of the attribute to set
     *
     * Set these attribute on each ns3::NbP2PChannel created
     * by NbP2PHelper::Install
     */
     ...
     *
     * This method creates a ns3::NbP2PChannel with the
     * attributes configured by NbP2PHelper::SetChannelAttribute,
     * then, for each node in the input container, we create a
     * ns3::NbP2PNetDevice with the requested attributes,
     * a queue for this ns3::NetDevice, and associate the resulting
     * ns3::NetDevice with the ns3::Node and ns3::NbP2PChannel.
     */
    ...
    // Added for create switch port device in Node b
    NetDeviceContainer Install4Switch(Ptr<Node> a, Ptr<Node> b);
  ...
  private:
    ...
    ObjectFactory m_deviceFactory4Switch;  //!< Device Factory specially for switch port device
...
template <typename... Ts>
void
NbP2PHelper::SetQueue(std::string type, Ts&&... args)
{
