...
#ifndef NB_CSMA_CHANNEL_H
#define NB_CSMA_CHANNEL_H
...
class NbCsmaNetDevice;

/**
 * @ingroup csma
 * @brief NbCsmaNetDevice Record
 *
 * Stores the information related to each net device that is
 * connected to the channel.
 */
class NbCsmaDeviceRec
{
  public:
    Ptr<NbCsmaNetDevice> devicePtr; //!< Pointer to the net device
     ...
     */
    NbCsmaDeviceRec(Ptr<NbCsmaNetDevice> device);

    /**
     * Copy constructor
     * @param o the object to copy
     */
    NbCsmaDeviceRec(const NbCsmaDeviceRec& o);
...
/**
 * @ingroup csma
 * @brief NbCsma Channel.
 *
 * This class represents a simple NbCsma channel that can be used
 ...
 */
class NbCsmaChannel : public Channel
{
  public:
    /**
    ...
    /**
     * @brief Create a NbCsmaChannel
     */
    NbCsmaChannel();
    /**
     * @brief Destroy a NbCsmaChannel
     */
    ~NbCsmaChannel() override;

    // Delete copy constructor and assignment operator to avoid misuse
    NbCsmaChannel(const NbCsmaChannel&) = delete;
    NbCsmaChannel& operator=(const NbCsmaChannel&) = delete;
     ...
     */
    int32_t Attach(Ptr<NbCsmaNetDevice> device);
     ...
     * can't be found.
     */
    bool Detach(Ptr<NbCsmaNetDevice> device);
     ...
     * channel or can't be found.
     */
    bool Reattach(Ptr<NbCsmaNetDevice> device);
     ...
     * number is needed
     */
    int32_t GetDeviceNum(Ptr<NbCsmaNetDevice> device);
    ...
    /**
     * @return Get a NbCsmaNetDevice pointer to a connected network device.
     *
     ...
     * with deviceId i.
     */
    Ptr<NbCsmaNetDevice> GetNbCsmaDevice(std::size_t i) const;
  ...
  private:
     ...
     */
    std::vector<NbCsmaDeviceRec> m_deviceList;
