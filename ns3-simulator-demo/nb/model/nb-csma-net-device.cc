...
NS_LOG_COMPONENT_DEFINE("NbCsmaNetDevice");

NS_OBJECT_ENSURE_REGISTERED(NbCsmaNetDevice);

TypeId
NbCsmaNetDevice::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::NbCsmaNetDevice")
            .SetParent<NetDevice>()
            .SetGroupName("Csma")
            .AddConstructor<NbCsmaNetDevice>()
            .AddAttribute("HostId",
                          "The NetBlocks host id, unsigned 64-bit",
                          UintegerValue(0),
                          MakeUintegerAccessor(&NbCsmaNetDevice::m_hostId),
                          MakeUintegerChecker<uint64_t>())
            .AddAttribute("Mtu",
                          "The MAC-level Maximum Transmission Unit",
                          UintegerValue(DEFAULT_MTU),
                          MakeUintegerAccessor(&NbCsmaNetDevice::SetMtu, &NbCsmaNetDevice::GetMtu),
                          MakeUintegerChecker<uint16_t>())
            .AddAttribute("EncapsulationMode",
                          "The link-layer encapsulation type to use.",
                          EnumValue(DIX),
                          MakeEnumAccessor<EncapsulationMode>(&NbCsmaNetDevice::SetEncapsulationMode),
                          MakeEnumChecker(DIX, "Dix", LLC, "Llc"))
            .AddAttribute("SendEnable",
                          "Enable or disable the transmitter section of the device.",
                          BooleanValue(true),
                          MakeBooleanAccessor(&NbCsmaNetDevice::m_sendEnable),
                          MakeBooleanChecker())
            .AddAttribute("ReceiveEnable",
                          "Enable or disable the receiver section of the device.",
                          BooleanValue(true),
                          MakeBooleanAccessor(&NbCsmaNetDevice::m_receiveEnable),
                          MakeBooleanChecker())
            .AddAttribute("ReceiveErrorModel",
                          "The receiver error model used to simulate packet loss",
                          PointerValue(),
                          MakePointerAccessor(&NbCsmaNetDevice::m_receiveErrorModel),
            ...
            .AddAttribute("TxQueue",
                          ...
                          PointerValue(),
                          MakePointerAccessor(&NbCsmaNetDevice::m_queue),
            ...
            .AddTraceSource("MacTx",
                            ...
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_macTxTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("MacTxDrop",
                            "Trace source indicating a packet has been "
                            "dropped by the device before transmission",
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_macTxDropTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("MacPromiscRx",
                            ...
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_macPromiscRxTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("MacRx",
                            ...
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_macRxTrace),
                            "ns3::Packet::TracedCallback")
#if 0
    ...
    .AddTraceSource ("MacRxDrop",
                     ...
                     MakeTraceSourceAccessor (&NbCsmaNetDevice::m_macRxDropTrace),
                     "ns3::Packet::TracedCallback")
#endif
            .AddTraceSource("MacTxBackoff",
                            "Trace source indicating a packet has been "
                            "delayed by the CSMA backoff process",
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_macTxBackoffTrace),
                            "ns3::Packet::TracedCallback")
            //
            ...
            .AddTraceSource("PhyTxBegin",
                            ...
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_phyTxBeginTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("PhyTxEnd",
                            "Trace source indicating a packet has been "
                            "completely transmitted over the channel",
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_phyTxEndTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("PhyTxDrop",
                            "Trace source indicating a packet has been "
                            "dropped by the device during transmission",
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_phyTxDropTrace),
                            "ns3::Packet::TracedCallback")
#if 0
    // Not currently implemented in this device
    .AddTraceSource ("PhyRxBegin",
                     ...
                     MakeTraceSourceAccessor (&NbCsmaNetDevice::m_phyRxBeginTrace),
                     "ns3::Packet::TracedCallback")
#endif
            .AddTraceSource("PhyRxEnd",
                            "Trace source indicating a packet has been "
                            "completely received by the device",
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_phyRxEndTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("PhyRxDrop",
                            "Trace source indicating a packet has been "
                            "dropped by the device during reception",
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_phyRxDropTrace),
                            "ns3::Packet::TracedCallback")
            //
            ...
            .AddTraceSource("Sniffer",
                            ...
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_snifferTrace),
                            "ns3::Packet::TracedCallback")
            .AddTraceSource("PromiscSniffer",
                            "Trace source simulating a promiscuous "
                            "packet sniffer attached to the device",
                            MakeTraceSourceAccessor(&NbCsmaNetDevice::m_promiscSnifferTrace),
                            "ns3::Packet::TracedCallback");
    return tid;
}

NbCsmaNetDevice::NbCsmaNetDevice()
    : m_linkUp(false)
{
...
void
NbCsmaNetDevice::SetEncapsulationMode(EncapsulationMode mode)
{
...
NbCsmaNetDevice::EncapsulationMode
NbCsmaNetDevice::GetEncapsulationMode()
{
    NS_LOG_FUNCTION_NOARGS();
    return m_encapMode;
}
...
bool
NbCsmaNetDevice::SetMtu(uint16_t mtu)
{
...
void
NbCsmaNetDevice::SetSendEnable(bool sendEnable)
{
...
void
NbCsmaNetDevice::SetReceiveEnable(bool receiveEnable)
{
...
bool
NbCsmaNetDevice::IsSendEnabled() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_sendEnable;
}
...
bool
NbCsmaNetDevice::IsReceiveEnabled() const
{
    NS_LOG_FUNCTION_NOARGS();
...
void
NbCsmaNetDevice::SetInterframeGap(Time t)
{
    NS_LOG_FUNCTION(t);
    m_tInterframeGap = t;
}
...
void
NbCsmaNetDevice::SetBackoffParams(Time slotTime,
                                uint32_t minSlots,
                                uint32_t maxSlots,
                                uint32_t ceiling,
                                uint32_t maxRetries)
...
#if 0
bool
NbCsmaNetDevice::ProcessHeader (Ptr<Packet> p, uint16_t & param)
{
  ...
  switch (m_encapMode)
    ...
    case ILLEGAL:
    default:
      NS_FATAL_ERROR ("NbCsmaNetDevice::ProcessHeader(): Unknown packet encapsulation mode");
      break;
    }
  return true;
}
...
NbCsmaNetDevice::TransmitStart()
{
    ...
    //
    NS_ASSERT_MSG(m_currentPkt, "NbCsmaNetDevice::TransmitStart(): m_currentPkt not set");
    ...
    if (m_channel->GetState() != IDLE)
    {
        ...
        if (m_backoff.MaxRetriesReached())
        {
            ...
            //
            // printf("Channel busy, max retries reached, dropping packet\n");
            TransmitAbort();
        }
        else
        {
            ...
            // printf("Channel busy, backing off for %.6f seconds\n",
            //        backoffTime.GetSeconds());
            NS_LOG_LOGIC("Channel busy, backing off for " << backoffTime.As(Time::S));

            Simulator::Schedule(backoffTime, &NbCsmaNetDevice::TransmitStart, this);
        }
    }
    else
    {
        ...
        else
        {
            ...
            Simulator::Schedule(tEvent, &NbCsmaNetDevice::TransmitCompleteEvent, this);
        }
    }
}

void
NbCsmaNetDevice::TransmitAbort()
{
    NS_LOG_FUNCTION_NOARGS();
    ...
    //
    NS_ASSERT_MSG(m_currentPkt, "NbCsmaNetDevice::TransmitAbort(): m_currentPkt zero");
    NS_LOG_LOGIC("m_currentPkt=" << m_currentPkt);
    ...
    else
    {
        ...
        NS_ASSERT_MSG(packet,
                      "NbCsmaNetDevice::TransmitAbort(): IsEmpty false but no Packet on queue?");
        m_currentPkt = packet;
...
void
NbCsmaNetDevice::TransmitCompleteEvent()
{
    NS_LOG_FUNCTION_NOARGS();
    ...
    NS_ASSERT_MSG(m_txMachineState == BUSY,
                  "NbCsmaNetDevice::transmitCompleteEvent(): Must be BUSY if transmitting");
    ...
    //
    NS_ASSERT_MSG(m_currentPkt, "NbCsmaNetDevice::TransmitCompleteEvent(): m_currentPkt zero");
    NS_LOG_LOGIC("m_currentPkt=" << m_currentPkt);
    NS_LOG_LOGIC("Pkt UID is " << m_currentPkt->GetUid() << ")");
    ...
    Simulator::Schedule(m_tInterframeGap, &NbCsmaNetDevice::TransmitReadyEvent, this);
}

void
NbCsmaNetDevice::TransmitReadyEvent()
{
    NS_LOG_FUNCTION_NOARGS();
    ...
    NS_ASSERT_MSG(m_txMachineState == GAP,
                  "NbCsmaNetDevice::TransmitReadyEvent(): Must be in interframe gap");
    m_txMachineState = READY;
    ...
    //
    NS_ASSERT_MSG(!m_currentPkt, "NbCsmaNetDevice::TransmitReadyEvent(): m_currentPkt nonzero");
    ...
    else
    {
        Ptr<Packet> packet = m_queue->Dequeue();
        NS_ASSERT_MSG(packet,
                      "NbCsmaNetDevice::TransmitReadyEvent(): IsEmpty false but no Packet on queue?");
        m_currentPkt = packet;
        m_snifferTrace(m_currentPkt);
        m_promiscSnifferTrace(m_currentPkt);
        TransmitStart();
...
bool
NbCsmaNetDevice::Attach(Ptr<NbCsmaChannel> ch)
{
    ...
    //
    // We still use the Ethernet interframe gap of 96 bit times.
    //
...
void
NbCsmaNetDevice::SetQueue(Ptr<Queue<Packet>> q)
{
    NS_LOG_FUNCTION(q);
    m_queue = q;
}
...
void
NbCsmaNetDevice::SetReceiveErrorModel(Ptr<ErrorModel> em)
{
    NS_LOG_FUNCTION(em);
...
void
NbCsmaNetDevice::Receive(Ptr<const Packet> packet, Ptr<NbCsmaNetDevice> senderDevice)
{
    ...
    //
    // printf("!!!!! Received: begin callback\n");
    m_rxCallback(this, pktCopy, 0, Address());
}

Ptr<Queue<Packet>>
NbCsmaNetDevice::GetQueue() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_queue;
}
...
void
NbCsmaNetDevice::SetIfIndex(const uint32_t index)
{
...
uint32_t
NbCsmaNetDevice::GetIfIndex() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_ifIndex;
}
...
Ptr<Channel>
NbCsmaNetDevice::GetChannel() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_channel;
}
...
void
NbCsmaNetDevice::SetAddress(Address address)
{
    // NS_LOG_FUNCTION_NOARGS();
...
Address
NbCsmaNetDevice::GetAddress() const
{
    // NS_LOG_FUNCTION_NOARGS();
    // return m_address;
    return Address();
...
bool
NbCsmaNetDevice::IsLinkUp() const
{
    NS_LOG_FUNCTION_NOARGS();
    return m_linkUp;
}
...
void
NbCsmaNetDevice::AddLinkChangeCallback(Callback<void> callback)
{
...
bool
NbCsmaNetDevice::IsBroadcast() const
{
    NS_LOG_FUNCTION_NOARGS();
    return true;
}
...
Address
NbCsmaNetDevice::GetBroadcast() const
{
    NS_LOG_FUNCTION_NOARGS();
...
bool
NbCsmaNetDevice::IsMulticast() const
{
    NS_LOG_FUNCTION_NOARGS();
    return true;
}
...
Address
NbCsmaNetDevice::GetMulticast(Ipv4Address multicastGroup) const
{
...
bool
NbCsmaNetDevice::IsPointToPoint() const
{
    NS_LOG_FUNCTION_NOARGS();
    return false;
}
...
bool
NbCsmaNetDevice::IsBridge() const
{
    NS_LOG_FUNCTION_NOARGS();
    return false;
}
...
bool
NbCsmaNetDevice::Send(Ptr<Packet> packet, const Address& dest, uint16_t protocolNumber)
{
    NS_LOG_FUNCTION(packet << dest << protocolNumber);
    return SendFrom(packet, ns3::Address(), dest, protocolNumber);
}

bool
NbCsmaNetDevice::SendFrom(Ptr<Packet> packet,
                        const Address& src,
                        const Address& dest,
                        uint16_t protocolNumber)
{
    ...
    if (m_txMachineState == READY)
    {
        if (!m_queue->IsEmpty())
        {
            Ptr<Packet> packet = m_queue->Dequeue();
            NS_ASSERT_MSG(packet,
                          "NbCsmaNetDevice::SendFrom(): IsEmpty false but no Packet on queue?");
            m_currentPkt = packet;
            m_promiscSnifferTrace(m_currentPkt);
            m_snifferTrace(m_currentPkt);
            TransmitStart();
...
void
NbCsmaNetDevice::SetNode(Ptr<Node> node)
{
...
bool
NbCsmaNetDevice::NeedsArp() const
{
    NS_LOG_FUNCTION_NOARGS();
    return true;
}
...
void
NbCsmaNetDevice::SetReceiveCallback(NetDevice::ReceiveCallback cb)
{
    NS_LOG_FUNCTION(&cb);
    m_rxCallback = cb;
}
...
Address
NbCsmaNetDevice::GetMulticast(Ipv6Address addr) const
{
...
void
NbCsmaNetDevice::SetPromiscReceiveCallback(NetDevice::PromiscReceiveCallback cb)
{
    NS_LOG_FUNCTION(&cb);
...
bool
NbCsmaNetDevice::SupportsSendFrom() const
{
    NS_LOG_FUNCTION_NOARGS();
    return true;
}
...
int64_t
NbCsmaNetDevice::AssignStreams(int64_t stream)
{
