...
#ifndef NB_CSMA_NET_DEVICE_H
#define NB_CSMA_NET_DEVICE_H
 ...
 */
class NbCsmaNetDevice : public NetDevice
{
  public:
    /**
     ...
     *
     * This is the default constructor for a NbCsmaNetDevice.
     */
    NbCsmaNetDevice();
     ...
     *
     * This is the destructor for a NbCsmaNetDevice.
     */
    ~NbCsmaNetDevice() override;
     ...
     */
    bool Attach(Ptr<NbCsmaChannel> ch);
    ...
    /**
     * Receive a packet from a connected NbCsmaChannel.
     *
     * The NbCsmaNetDevice receives packets from its connected channel
     ...
     */
    void Receive(Ptr<const Packet> p, Ptr<NbCsmaNetDevice> sender);
     ...
     *
     */
    void SetEncapsulationMode(NbCsmaNetDevice::EncapsulationMode mode);
     ...
     */
    NbCsmaNetDevice::EncapsulationMode GetEncapsulationMode();
  ...
  protected:
    ...
    /**
     * Add Header is done by nb-stack class instead of here.
  ...
  private:
     ...
     */
    NbCsmaNetDevice& operator=(const NbCsmaNetDevice& o);
     ...
     * @param o object to copy
     */
    NbCsmaNetDevice(const NbCsmaNetDevice& o);
    ...
    /**
     * The stored netblock address which has been assigned to this device.
     */
    uint64_t m_hostId;
