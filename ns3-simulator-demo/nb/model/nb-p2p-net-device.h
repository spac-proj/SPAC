...
#ifndef NB_P2P_NET_DEVICE_H
#define NB_P2P_NET_DEVICE_H
 ...
 *
 * This NbP2PNetDevice class specializes the NetDevice abstract
 * base class.  Together with a NbP2PChannel (and a peer
 * NbP2PNetDevice), the class models, with some level of
 ...
 * propagation delay is set in the NbP2PChannel).
 */
class NbP2PNetDevice : public NetDevice
{
  public:
    /**
    ...
    /**
     * Construct a NbP2PNetDevice
     *
     * This is the constructor for the NbP2PNetDevice.  It takes as a
    ...
    /**
     * Destroy a NbP2PNetDevice
     *
     * This is the destructor for the NbP2PNetDevice.
     */
    ~NbP2PNetDevice();

    // Delete copy constructor and assignment operator to avoid misuse
    NbP2PNetDevice& operator=(const NbP2PNetDevice&) = delete;
    NbP2PNetDevice(const NbP2PNetDevice&) = delete;
     ...
     */
    bool Attach(Ptr<NbP2PChannel> ch);

    /**
     * Attach a queue to the NbP2PNetDevice.
     *
     * The NbP2PNetDevice "owns" a queue that implements a queueing
    ...
    /**
     * Attach a receive ErrorModel to the NbP2PNetDevice.
     *
     * The NbP2PNetDevice may optionally include an ErrorModel in
    ...
    /**
     * Receive a packet from a connected NbP2PChannel.
     *
     * The NbP2PNetDevice receives packets from its connected channel
  ...
  protected:
    ...
    /**
     * The NbP2PChannel to which this NbP2PNetDevice has been
     * attached.
     */
    Ptr<NbP2PChannel> m_channel;

    /**
     * The Queue which this NbP2PNetDevice uses as a packet source.
     * Management of this Queue has been delegated to the NbP2PNetDevice
